...
Class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $errMessages = null)
    {
        $this->options = [
        ...
        if ($errMessages) {
            $this->errMessages = array_merge($this->errMessages, $errMessages);
        }
        if ($initialize) {
            $this->initialize();
        }
    ...
    protected function getDownloadURL($fileName, $version = null) {
    ...
    protected function count_file_objects() {
        return count($this->get_file_objects('isValidFileObject'));
    }
    ...
    protected function get_error_message($error) {
        return array_key_exists($error, $this->errMessages) ?
            $this->errMessages[$error] : $error;
    }
    ...
    protected function download()
    {
        ...
        if ($this->isValidFileObject($fileName)) {
            $file_path = $this->getUploadPath($fileName, $this->get_version_param());
    ...
    public function delete($printResponse = true)
    {
        ...
        return $this->generateResponse(['success' => $success], $printResponse);
    }
